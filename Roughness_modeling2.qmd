---
title: "Ra modeling with SVM radial - Helical milling of Inconel 718 with round carbide inserts"
...
set.seed(1805)
pdp_fza <- model_profile(explainer_svm_r, N = 500, variables = "fza", groups = "lc")
pdp_fzt <- model_profile(explainer_svm_r, N = 500, variables = "fzt", groups = "lc")
pdp_vc <- model_profile(explainer_svm_r, N = 500, variables = "vc", groups = "lc")
```
